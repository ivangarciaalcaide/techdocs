...
!!! note "Modificar esta introducción o prólogo" 
    Esto está copiado y debe rehacerse. Estamos de pruebas...

Este manual está orientado a entender Ansible de manera práctica para poder trabajar con ello. Se contará cómo
instalarlo en distribuciones Debian/Ubuntu y derivadas y cómo configurarlo de manera básica.
